...
description: This skill provides reference guidance for citation verification in academic writing. Use when the user asks about "citation verification best practices", "how to verify references", "preventing fake citations", or needs guidance on citation accuracy. This skill supports chinese-degree-thesis-writing (and legacy ml-paper-writing) by providing detailed verification principles and common error patterns.
...
### Using with chinese-degree-thesis-writing

The verification principles of this skill are integrated into the Citation Workflow of the `chinese-degree-thesis-writing` skill.

**Auto-trigger**: Citation verification is automatically executed in thesis writing mode and can also be used in legacy ml-paper-writing mode.
...
**Integration**: The principles of this skill are integrated into chinese-degree-thesis-writing for automatic verification, while remaining compatible with ml-paper-writing.
