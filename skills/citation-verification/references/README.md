...
**实际的引用验证应优先使用 `chinese-degree-thesis-writing` 中的 Citation Workflow：**
...
详见 `chinese-degree-thesis-writing` 的 Citation Workflow 说明（legacy `ml-paper-writing` 仍兼容）。

## 使用建议

**对于日常论文写作**:
- ✅ 使用 `chinese-degree-thesis-writing` 的 Citation Workflow
