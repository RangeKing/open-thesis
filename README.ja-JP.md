...
- **2026-04-24**: **Project-scoped Obsidian KB workflow を統合** — Obsidian の project knowledge workflow を `Research/{project-slug}/`、`Sources/*`、`Results/Reports`、`02-Index.md`、`_system/registry.md` を中心に再構成しました。重複していた旧 Obsidian memory skills を `obsidian-project-kb-core`、`obsidian-source-ingestion`、`obsidian-literature-workflow`、`obsidian-kb-artifacts` に統合し、`.claude/project-memory/*` は runtime binding layer として残し、`02-Index.md` を registry mirror ではなく人間向け navigation page として位置づけました。
